...
- **MCP** (16 tools): `task_create`, `task_list`, `task_claim`, `task_update`, `task_next`, `task_delete`, `task_search`, `task_expand`, `task_comment`, `task_stage`, `task_query`, `task_artifact`, `task_config`, `task_dependency`, `task_collaborator`, `task_approval`
