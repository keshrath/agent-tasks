...
- **MCP** (32 tools): `task_create`, `task_list`, `task_claim`, `task_advance`, `task_complete`, `task_add_artifact`, `task_decision`, `task_comment`, `task_search`, `task_add_collaborator`, `task_request_approval`, `task_approve`, `task_reject`, `task_review_cycle`, `task_generate_rules`, etc.
